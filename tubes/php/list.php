      ...
      <div class="container">
        <div class="nav-wrapper">
          ...
          <ul class="right hide-on-med-and-down">
            ...
            <li><a href="list.php">List Main Character</a></li>
  ...
  <div class="container">
    <div class="search white-text">
      <form action="" method="POST">
        ...
        <button type="submit" name="cari" class="waves-effect waves-light brown darken-4 btn" style="font-size: 18px;"><i class="material-icons">search</i>Search</button>
      </form>
    </div>
      ...
      <?php else : ?>
        ...
        <?php foreach ($anime as $anm) : ?>
          <tr class="grey darken-3 white-text">
            ...
            <td class="center"> <img src="../assets/img/<?= $anm["img"]; ?>" width="200px"></td>
            <td><?= $anm["nama"] ?></td>
            <td class="center">
              <a href="detail.php?id=<?= $anm['id']; ?>" class="waves-effect waves-light green btn">Lihat detail</a>
            </td>
          </tr>
          <?php $i++; ?>
        <?php endforeach; ?>
