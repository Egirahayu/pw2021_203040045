...
<body>
    <div class="container">
            ...
            <?php else : ?>
                ...
                <?php foreach($anime as $anm) : ?>
                    <tr class="grey darken-3 white-text">
                        ...
                        <td class="center"><img src="../assets/img/<?= $anm['img']; ?>" alt=""></td>
                        <td><?= $anm['nama']; ?></td>
                        <td><?= $anm['anime']; ?></td>
                        <td><?= $anm['rilis']; ?></td>
                        <td class="center "> <a class="waves-effect waves-light green btn"> <?= $anm["status"]; ?> </a> </td>
                    </tr>
                    <?php $i++; ?>
                <?php endforeach; ?>
            <?php endif; ?>
        ...
        <div class="logout">
            <a href="logout.php" class="waves-effect waves-light green btn-large">Logout</a> 
        </div>
    </div>
